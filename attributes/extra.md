...
|-|:----------------------------------- |:--------:|:-----------:|:--------------------------- |:-------------- |
| | **Building function**               | each LA  | enum        | building-function           | MR-D1.2.3-4.2: "commercial", "industrial", "office", "public", "residential" | 
| | **Building energy label**           | each LA  | none        | building-energy-label       | A, B, C, etc.  |
...
| | **Rooftop function**                | each LA  | enum        | rooftop-function            | |
...
| **Zone green corridor**               | each LA  | no             | ?         | zone-green corridor    | |
| **Zone public spaces**                | each LA  | no             | ?         | zone-public spaces      | | 
