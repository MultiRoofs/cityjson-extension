...
|-|:----------------------------------- |:--------:|:-----------:|:--------------------------- |:-------------- |
| | **Building ownership**              | each LA  |             | building-ownership          | MR-D1.2.3-5|
| | **Building type**                   | each LA  | enum        | building-type               | MR-D1.2.3-4.2 |
| | **Building function**               | each LA  | enum        | building-function           | MR-D1.2.3-4.2-usage|
